 ...
 * 
 * Changes by Christian Melchior <christian@ilios.dk>
 * - Fix minimum width for the ICS Holo Theme.
 * - Shows preference summary when binding the view.
 */
...
public class ColorPickerPreference
	...
	public void onColorChanged(int color) {
		...
		mValue = color;
		setPreviewColor();
		setSummary(ColorPickerPreference.convertToARGB(Integer.valueOf(String.valueOf(getValue()))));
